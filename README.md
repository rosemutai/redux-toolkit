...
<div align="center">
  ...
  <h3><b>react-toolkit project</b></h3>
...
# 📖 react-toolkit <a name="about-project"></a>

This project is built with React

**react-toolkit** is a simple web app that I built while learning how to use React Redux
...
Go to github and find the repository react-toolkit
...
```sh
  cd my-folder
  git clone git@github.com:rosemutai/react-toolkit.git
```
--->
### Install
...
Example:
```sh
git@github.com:rosemutai/react-toolkit.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
Feel free to check the [https://github.com/rosemutai/react-toolkit/issues.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
I would like to thank Microverse for this exercise and <a href="https://www.youtube.com/watch?v=bbkBuqC1rU4">FreeCodeCamp</a> for this tutorial.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
